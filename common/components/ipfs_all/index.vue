...
export default {
  ...
  computed: {
    ...
    githubLink() {
      ...
      return `https://github.com/${this.user.username}/matataki-save/blob/main/${year}/${date}/${this.hash}.json`
    },
    githubHistoryLink() {
      const year = this.hash.substring(2, 6)
      const date = this.hash.substring(6, 8)
      return `https://github.com/${this.user.username}/matataki-save/commits/main/${year}/${date}/${this.hash}.json`
    }
  },
  methods: {
    copy(val) {

export default {
    ...
    publish: {
        ...
        importDes1: '目前支持：链闻、橙皮书、微信、知乎专栏、Matters、简书、微博文章、币乎。',
    ...
    user: {
        ...
        infoSetting: '资料设置',
        accountSetting: '账号管理',
        matatakiAuthAccountSetting: 'Matataki Auth 绑定的账号',
        systemSetting: '其他操作',
        wallet: '钱包详情',
        point: '积分详情',
        invite: '邀请记录',
    ...
    thirdParty: {
        ...
        bindExplanation3: '瞬MatatakiAuth支持绑定的账号，可以解绑后再次被绑定',
        bindExplanation4: '通过瞬MatatakiAuth绑定的账号均不可用于登录',
        useMatatakiAuthToBind: '将跳转到 Matataki Auth 来完成绑定',
        unbind: '取消绑定',
        mainAccount: '主账号',
        bindFailed: '绑定失败',
    ...
    dashboard: {
        ...
        statistics: '数据统计',
        today: '今日',
        dataIncrementTrend: '数据增量趋势',
        sourceManuscript: '来源稿件',
        likes: '点赞次数',
        frequency: '次数',

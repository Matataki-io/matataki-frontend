export default {
  ...
  success: {
    ...
    public: 'Send successfully, automatically go to your published article',
  ...
  about: {
    ...
    homeTitle: 'a content platform for permanent storage and copyright claims',
    homeDes:
    ...
    stageDes31: 'Build a platform for human knowledge sharing and innovation',
  ...
  publish: {
    ...
    contentPlaceholder:
      'Please enter the text in Markdown format to start editing',
  ...
  user: {
    ...
    myDraft: 'My draft',
    deleteDraftFail:
      'Automatically delete draft failed, please delete manually',
    original: 'original',
    support: 'investment',
    article: 'commodity',
    shop: 'goods',

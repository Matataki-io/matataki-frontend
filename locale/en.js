export default {
    ...
    error: {
        ...
        failTry: 'Got Failed, try again please.',
        ...
        pullRequestFail: 'Fail to pull request, click to reload.',
    ...
    auth: {
        ...
        eosTitle: 'Login with EOS Wallets',
        ...
        twitterTitle: 'Login with Twitter (still in development)',
        ...
        pcLoginViewPointDetail: 'View point detail in PC',
    ...
    imgUpload: {
        ...
        subtitle2: 'Adjust image size and position. Recommended resolution is bigger than 1080p, crop ratio is 120:29',
        save: 'Save',
    ...
    about: {
        ...
        homeDes: 'Instant Matataki is a high-quality content platform that protects the rights and interests of creators. The IPFS protocol is used to ensure the permanent access to content and information on enquiry. The Fan ticket is used to motivate creators, explorers, and evangelists to build future super knowledge Link network; committed to return to a more open decentralized Internet.',
        ...
        programDes2: 'Matataki adopts the InterPlanetary File System protocol. Each file has a unique copy, which reduces the waste of storage resources and reduces the storage cost, so that platform resources are never lost, the website is never shut down, and the user\'s rights and interests are permanently effective.',
        ...
        blockDes31: 'Matataki will give back to all the co-founders who participated in the ecological construction!',
    ...
    publish: {
        ...
        point: 'point',
        coverTitle: 'cover',
        coverDes: 'Please upload a picture with the size ratio of 2:1',
        tagTitle: 'Select tag',

export default {
  ...
  thirdParty: {
    ...
    usernameNoFullUrl: ' username (no full URL required)',
    bindExplanation1: 'Instant Matataki supports binding accounts that have not yet been registered and can be bound again after the account is unbound.',

    ...
    <div class="home-effect">
      ...
      <div class="mw flex recording">
        <div v-scroll-reveal="{ distance: '20px'}" class="home-text">
          ...
          <a target="_blank" class="read-more" href="http://www.miit.gov.cn/n1146290/n1146402/n1146445/c6180238/part/6180297.pdf">阅读更多 >>></a>
        </div>
    ...
    <div class="home-block ipfs">
      ...
      <div class="mw flex">
        <div v-scroll-reveal="{ distance: '20px'}" class="home-text ipfs">
          ...
          <a target="_blank" class="read-more" href="http://www.ipfs.cn/news/info-100533.html">阅读更多 >>></a>
        </div>
    ...
    <div class="home-block flex point">
      <div class="mw flex">
        ...
        <div v-scroll-reveal="{ distance: '20px'}" class="home-text point">
          ...
          <a target="_blank" class="read-more" href="https://www.smartsignature.io/p/781">阅读更多 >>></a>
        </div>
      </div>
    </div>
